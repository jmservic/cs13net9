...
#region Summarizing custom type choices
C1 c1 = new() { Name = "Bob" };
c1.Name = "Bill";
...
WriteLine($"dv1 == dv5: {dv1 == dv5}"); //Compile error because no default implementation, but works if class is defined as a record struct!
#endregion