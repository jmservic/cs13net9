...
keywords.Add("float", "Single precious floating point number");
...
/* Alternatie syntax; compiler converts this to acalls to Add method.
Dictionary<string, string> keywords = new()
{
    ["int"] = "32-bit integer data type",
    ["long"] = "64-bit integer data type",
...
// Creating a frozen collection has an overhead to perform sometimes complex optimizations.
